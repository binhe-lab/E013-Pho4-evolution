...
p <- dat %>% 
  ...
  geom_segment(aes(x = pos_aln, xend = pos_Scer, y = 1.55, yend = 1.95), color = "gray80") +
  geom_segment(aes(x = pos_Cgla, xend = pos_aln, y = 1.05, yend = 1.45), color = "gray80") +
  scale_color_fermenter(palette = "Greys", direction = 1) +
  ...
  geom_rect(data = regions,
            aes(xmin = begin_Cgla - 532/2, xmax = end_Cgla - 532/2,
                ymin = 0.85, ymax = 1.05), 
            fill = "steelblue", color = "gray90", linewidth = lw) +
