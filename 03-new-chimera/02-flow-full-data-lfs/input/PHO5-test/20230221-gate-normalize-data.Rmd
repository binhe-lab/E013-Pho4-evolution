...
sample <- read.csv("20230221-sample-list.csv") %>% column_to_rownames(var = "file")
data.path = "/Volumes/rdss_bhe2/Project/E013-Pho4p-evolution/flow-cytometry/data/20230224-LS-chimera-production-run/PHO5-flow-data/20230221pho5pr-day8/"
...
write_tsv(final, "20230221-gated-median-out.txt")
```
