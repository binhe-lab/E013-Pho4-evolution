...
data.path = "/Volumes/rdss_bhe2/Project/E013-Pho4p-evolution/flow-cytometry/data/20230224-LS-chimera-production-run/PHO5-flow-data/20230209pho5-day2/"
...
```{r}
sample <- read.csv("20230209-sample-list.csv") %>% 
...
```{r}
list.redo <- c("239-555-1", "239-555-2", "239-555-3")
...
write_tsv(final, "20230209-gated-median-out.txt")
```
