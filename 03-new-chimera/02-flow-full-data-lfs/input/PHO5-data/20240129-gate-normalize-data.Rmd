---
title: "Testing Cg aa470 helix extension, day 2"
...
sample <- read.csv("20240129-sample-list.csv") %>% column_to_rownames(var = "file")
data.path = "/Volumes/rdss_bhe2/Project/E013-Pho4p-evolution/flow-cytometry/data/20240207-LS-mixed Sc45:Cg4 aa470/20240129/"
...
```
> Need to deal with 188-555-2

Implement the 2 cluster gates
```{r}
list.redo <- c("188-555-2")
...
write_tsv(final, "20240129-gated-median-out.txt")
```
