...
sample <- read.csv("20230220-sample-list.csv") %>% column_to_rownames(var = "file")
data.path = "/Volumes/rdss_bhe2/Project/E013-Pho4p-evolution/flow-cytometry/data/20230224-LS-chimera-production-run/PHO5-flow-data/20230220pho5pr-day7/"
...
write_tsv(final, "20230220-gated-median-out.txt")
```
