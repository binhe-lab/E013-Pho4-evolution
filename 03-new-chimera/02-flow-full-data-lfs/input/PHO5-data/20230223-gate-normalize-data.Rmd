...
date: "2023-02-23 (updated `r Sys.time()`)"
output:
  html_notebook:
    toc: true
    toc_depth: 4
...
data.path = "/Volumes/rdss_bhe2/Project/E013-Pho4p-evolution/flow-cytometry/data/20230224-LS-chimera-production-run/PHO5-flow-data/20230223pho5pr-day10/"
...
```{r}
list.redo <- c("334-555-1", "188-555-3")
...
write_tsv(final, "20230223-gated-median-out.txt")
```
