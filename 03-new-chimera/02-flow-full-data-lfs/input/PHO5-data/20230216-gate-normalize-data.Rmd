...
sample <- read.csv("20230216-sample-list.csv") %>% column_to_rownames(var = "file")
data.path = "/Volumes/rdss_bhe2/Project/E013-Pho4p-evolution/flow-cytometry/data/20230224-LS-chimera-production-run/PHO5-flow-data/20230216pho5-day4repeat/"
...
write_tsv(final, "20230216-gated-median-out.txt")
```
