---
title: "Sc45 in place of Sc5 test, day 2"
...
sample <- read.csv("20240125-sample-list.csv") %>% column_to_rownames(var = "file")
data.path = "/Volumes/rdss_bhe2/Project/E013-Pho4p-evolution/flow-cytometry/data/20240122-LS-chimeras-Sc5 replaced by Sc45/20240125/"
...
```{r eval=FALSE, include=FALSE}
test <- shortNames[c(3, 12*2+3, 12*5+3, 12*6+3)]
...
write_tsv(final, "20240125-gated-median-out.txt")
```
