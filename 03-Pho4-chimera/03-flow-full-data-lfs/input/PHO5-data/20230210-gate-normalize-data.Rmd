...
sample <- read.csv("20230210-sample-list.csv") %>% column_to_rownames(var = "file")
data.path = "/Volumes/rdss_bhe2/Project/E013-Pho4p-evolution/flow-cytometry/data/20230224-LS-chimera-production-run/PHO5-flow-data/20230210pho5-day3/"
...
write_tsv(final, "20230210-gated-median-out.txt")
```
