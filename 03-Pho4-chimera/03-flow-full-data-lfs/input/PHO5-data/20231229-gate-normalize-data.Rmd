---
title: "New 4/5 breakpoints in PHO5pr-RFP, day 2, plate 1"
...
sample <- read.csv("20231229-sample-list.csv") %>% column_to_rownames(var = "file")
data.path = "/Volumes/rdss_bhe2/Project/E013-Pho4p-evolution/flow-cytometry/data/20231228-LS-chimeras-PHO5pr-newbreakpoint/20231229-1/"
...
write_tsv(final, "20231229-gated-median-out.txt")
```
