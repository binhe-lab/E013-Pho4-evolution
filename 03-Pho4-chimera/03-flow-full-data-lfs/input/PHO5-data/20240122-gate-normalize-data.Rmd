---
title: "Sc45 in place of Sc5 test, day 1"
...
sample <- read.csv("20240122-sample-list.csv") %>% column_to_rownames(var = "file")
data.path = "/Volumes/rdss_bhe2/Project/E013-Pho4p-evolution/flow-cytometry/data/20240122-LS-chimeras-Sc5 replaced by Sc45/20240122/"
...
write_tsv(final, "20240122-gated-median-out.txt")
```
