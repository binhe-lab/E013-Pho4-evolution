---
title: "New 4/5 breakpoints in PHO5pr-RFP, day 1, plate 2"
...
sample <- read.csv("20231228-b-sample-list.csv") %>% column_to_rownames(var = "file")
data.path = "/Volumes/rdss_bhe2/Project/E013-Pho4p-evolution/flow-cytometry/data/20231228-LS-chimeras-PHO5pr-newbreakpoint/20231228-2/"
...
```
> a few samples, like 420-555-1 and 422-555-1 have fewer than 5,000 events after the singlet gate
...
```
> 422-555-3 and 425-555-2 had multiple populations.
...
write_tsv(final, "20231228-b-gated-median-out.txt")
```
