---
title: "Full set of chimeric Pho4 in PHO5pr-RFP, Day 9"
author: Bin He, Lindsey Snyder
date: "2023-02-22 (updated `r Sys.time()`)"
output:
  html_notebook:
    toc: true
    toc_depth: 4
...
sample <- read.csv("20230222-sample-list.csv") %>% column_to_rownames(var = "file")
data.path = "/Volumes/rdss_bhe2/Project/E013-Pho4p-evolution/flow-cytometry/data/20230224-LS-chimera-production-run/PHO5-flow-data/20230222pho5pr-day9/"
...
```
> 329-555-1/2/3 grew but didn't have as many cells.
> 334-555-1 had a ghost pop

Implement the 2 cluster gates
```{r}
list.redo <- c("334-555-1")
...
write_tsv(final, "20230222a-gated-median-out.txt")
```
